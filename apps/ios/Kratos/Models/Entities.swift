...
/// Provider-neutral lifecycle state from `kratos-proto`.
...
/// kratos-proto FolderListing (entities.rs:225): the device's answer to
...
/// kratos-proto RepoRef (entities.rs:193): one selectable ref from ListRefs.
...
/// kratos-proto WorktreeSpec (agent.rs, PR #159): a worktree the HOST
...
/// kratos-proto RunRequest (agent.rs:81). `reasoning` is lowercase
