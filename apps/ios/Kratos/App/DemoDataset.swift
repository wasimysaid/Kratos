...
final class DemoDataset {
    ...
    static func standard() -> DemoDataset {
        ...
        let kratos = Space(id: "space-kratos", deviceId: "dev-mac",
                          path: "/Users/dev/kratos", name: nil, gitDetected: true,
        ...
        let chats = [
            Chat(id: "chat-veil", deviceId: "dev-mac", title: "Streaming veil on transcript rows",
                 archived: false, cwd: "/Users/dev/.kratos/worktrees/kratos-veil-fade",
            ...
            Chat(id: "chat-tabs", deviceId: "dev-mac", title: "Tool group header colors",
                 ...
                 spaceId: kratos.id, lastSeenAt: now - 3_600_000),
    ...
    static let fileTree: [String: [String]] = [
        ...
        "/Users/dev/Projects": ["kratos", "dotfiles", "blog", "playground"],
        "/Users/dev/Projects/kratos": ["apps", "crates", "docs", "edge"],
    ...
    private static let repoNames: Set<String> = ["kratos", "dotfiles", "blog", "playground", "edge", "landing"]
    ...
    func listRefs(spacePath: String) -> [RepoRef] {
        ...
        let seeded: [RepoRef]
        if spacePath.contains("kratos") {
            seeded = [
                RepoRef(name: "main", current: true, worktreePath: nil),
                RepoRef(name: "veil-fade", current: false,
                        worktreePath: "/Users/dev/.kratos/worktrees/kratos-veil-fade"),
    ...
    func createWorktree(spacePath: String, base: String) -> String {
        ...
        let path = "/Users/dev/.kratos/worktrees/\((spacePath as NSString).lastPathComponent)-\(slug)"
        ...
        case "chat-veil":
            return [
                ...
                MessageEntry(id: "m2", role: .assistant, parts: [
                    ...
                    .tool(id: "tool2", call: RenderToolCall(tag: "editFile", fields: ["path": "Kratos/Transcript/Veil.swift"]), isError: false, resolved: true),
                    .tool(id: "tool3", call: RenderToolCall(tag: "exec", fields: ["command": "xcodebuild -scheme Kratos build"]), isError: false, resolved: true),
                    .text(id: "t1", text: """
        ...
        case "chat-tabs":
            return [
                ...
                MessageEntry(id: "m2", role: .assistant, parts: [
                    ...
                    .tool(id: "tool2", call: RenderToolCall(tag: "exec", fields: ["command": "cargo test -p kratos-ui tool_group"]), isError: true, resolved: true),
