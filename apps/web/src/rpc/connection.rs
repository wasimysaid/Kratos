...
//!
//! `BrowserSession` obtains an auth epoch, calls [`connect_client`], rejects
//! stale epochs around `EngineHandle::from_connected_client`, and observes
//! `RpcClient::watch_closed`.
