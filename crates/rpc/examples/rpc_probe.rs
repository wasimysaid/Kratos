...
//!
//! Usage:
//!   cargo run -p kratos-rpc --example rpc_probe -- ws://127.0.0.1:27801 LocalDevice '{}'
//!   cargo run -p kratos-rpc --example rpc_probe -- ws://127.0.0.1:27801 WatchSessions '{}' --stream 3

use kratos_rpc::connect_ws;
