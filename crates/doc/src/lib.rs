//! kratos-doc — session & workspace Loro doc schemas and the typed mirror layer.
//!
//! Port of kratos's `packages/session-doc`. The schema SHAPE (container names, part maps with
...
//!
//! Load-bearing invariant (measured in kratos, `oplog-shape.test.ts`): message parts are a
