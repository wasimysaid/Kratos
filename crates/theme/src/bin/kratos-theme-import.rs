...
use kratos_theme::Appearance;
use kratos_theme::vscode::{ImportOptions, import_file};
...
/// Convert a VS Code JSON/JSONC color theme into a complete Kratos theme draft.
#[derive(Debug, Parser)]
struct Args {
    #[arg(long)]
    input: PathBuf,
