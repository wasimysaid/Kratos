...
impl TerminalPanel {
    ...
    fn render_tab_bar(&mut self, chat: &str, cx: &mut Context<Self>) -> impl IntoElement + use<> {
        ...
        // Kratos terminal-panel.tsx: `flex h-10 items-center border-b
        ...
        div()
            ...
            .children(
                tab_elements
                    ...
                    .map(|(ix, key, title, selected, exited)| {
                        ...
                        // Kratos tab: `h-7 rounded-lg pl-2 pr-1 gap-1.5 text-xs`,
                        ...
                        let tab_el = div()
                            ...
                            .pr(px(4.0))
                            .rounded(px(8.0))
                            // kratos terminal-panel.tsx tab: `transition-colors`.
            ...
            .child(
                div()
                    ...
                    .rounded(px(8.0))
                    .cursor_pointer()
                    // kratos terminal-panel.tsx icon buttons: `transition-colors`.
                    .bg(motion::hover_blend(
                        "term-new-tab",
                        gpui::transparent_black(),
            ...
            // Collapse chevron pinned right (kratos "Hide terminal" ⌘J).
            .child(div().flex_1())
            .child(
                div()
