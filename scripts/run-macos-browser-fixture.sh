...
BINARY="$1"
shift
BUNDLE="$(mktemp -d "${TMPDIR:-/tmp}/kratos-browser-fixture.XXXXXX")/Fixture.app"
...
/usr/libexec/PlistBuddy -c 'Set :CFBundleIdentifier sh.kratos.browser-fixture' "$BUNDLE/Contents/Info.plist"
