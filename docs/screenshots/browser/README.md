...
which runs Kratos's shell with synthetic local chat data and a loopback website.
...
passed. The hosted Mac has a 1024px desktop, so the fixture uses Kratos's existing
